...
class OnPolicyBuffer(BaseBuffer):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(  # pylint: disable=too-many-arguments
        ...
        self.data['discounted_cost'] = torch.zeros((size,), dtype=torch.float32, device=device)
    ...
    def finish_path(
        ...
        self.data['discounted_cost'][path_slice] = discounted_cost
    ...
    def get(self) -> dict[str, torch.Tensor]:
        ...
        data = {
            ...
            'discounted_cost': self.data['discounted_cost'],
